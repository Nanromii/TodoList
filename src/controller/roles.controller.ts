...
} from '../utils/policies/impl/role.policies';
...
export class RoleController {
    ...
    async findOne(
        ...
        try {
            ...
            return new ApiResponse(
                'Fetched information of role successfully.',
                roleResponse,
            );
        } catch (error) {
            this.logger.error(
                `Failed to fetch information of role: ${error.message}`,
                error.stack,
            );
            throw new HttpException(
                new ApiResponse(
    ...
    async findAll(
        ...
        try {
            ...
            return new ApiResponse(
                `Fetched information of all roles successfully.`,
                response,
            );
        } catch (error) {
            this.logger.error(
                `Failed to fetch information of all roles: ${error.message}`,
                error.stack,
            );
            throw new HttpException(
                new ApiResponse(
